...
// ตัวอย่าง: อยากให้ Starter Car วิ่ง 120 km/h → เปลี่ยนค่าด้านล่างเป็น 120
// (การแปลง km/h → หน่วยภายในทำที่จุดเดียวใน system/vehicle.js ผ่าน MS_TO_KMH)
const STARTER_CAR_CONFIG = {
  topSpeedKmh:     121,    // ความเร็วสูงสุด (km/h) — ตัวเลขเดียวกับที่โชว์บน speedometer (ค่าเดิม ≈ 20 units/s)
  reverseSpeed:    8,     // ความเร็วถอยหลังสูงสุด
  accel:           8,     // อัตราเร่ง
  friction:        8,     // เบรค / แรงต้าน (ยิ่งมาก หยุดเร็วกว่า)
  turnSpeed:       1.8,   // วงเลี้ยว (ยิ่งมาก เลี้ยวแหลมกว่า)
  fuelConsumption: 0.1,   // อัตรากินน้ำมัน (หน่วย/วินาที ตอนขับปกติ, x1.5 ตอน sprint)
  seats:           2,     // จำนวนที่นั่ง (รวมคนขับ) — Starter Car นั่งได้ 4 คน
};
