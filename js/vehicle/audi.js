...
const AUDI_CONFIG = {
  topSpeedKmh:     153,   // ความเร็วสูงสุด (km/h) — ตัวเลขเดียวกับที่โชว์บน speedometer (ค่าเดิม ≈ 28 units/s)
  reverseSpeed:    10,     // ความเร็วถอยหลังสูงสุด
  accel:           10,    // อัตราเร่ง
  friction:        10,     // เบรค / แรงต้าน (ยิ่งมาก หยุดเร็วกว่า)
  turnSpeed:       2.0,   // วงเลี้ยว (ยิ่งมาก เลี้ยวแหลมกว่า)
  fuelConsumption: 0.2,   // อัตรากินน้ำมัน (หน่วย/วินาที ตอนขับปกติ, x1.5 ตอน sprint) — รถแรงกว่า กินน้ำมันมากกว่า
  seats:           4,     // จำนวนที่นั่ง (รวมคนขับ) — Audi เป็นรถซีดาน 4 ประตู นั่งได้ 4 คน
};
