...
const R32_CONFIG = {
  topSpeedKmh:     122,   // ความเร็วสูงสุด (km/h) — ตัวเลขเดียวกับที่โชว์บน speedometer (ค่าเดิม ≈ 34 units/s)
  reverseSpeed:    10,    // ความเร็วถอยหลังสูงสุด
  accel:           18,    // อัตราเร่ง
  friction:        5.0,   // เบรค / แรงต้าน
  turnSpeed:       2.6,   // วงเลี้ยว
  fuelConsumption: 0.30,  // อัตรากินน้ำมัน (หน่วย/วินาที)
};
