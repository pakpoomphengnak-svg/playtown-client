// ─────────────────────────────────────────────
// CHARACTER: MODEL (v2.1 — แก้ผม, เอาเงาออก)
// ─────────────────────────────────────────────
...
//const collar = makeBox(0.28, 0.06, 0.32, C_SHIRT);
...
charGroup.add(makeArm('L'));
charGroup.add(makeArm('R'));
...
charGroup.add(makeLeg('L'));
charGroup.add(makeLeg('R'));
